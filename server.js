...
// =========================================================================
// ប្រើប្រាស់ MONGODB_URI ពី File .env
mongoose
...
// =========================================================================
// ផ្នែកទី ៩៖ ការកំណត់ Static Files សម្រាប់ Frontend (ភ្ជាប់ HTML ជាមួយ Node)
// =========================================================================
...
app.listen(PORT, () => {
  ...
  console.log(`🔗 អាចចូលមើលបានតាមរយៈ: http://localhost:${PORT}`);
});
